...
npm install
npm run build
npm test                    # 357 tests (347 backend + 10 frontend)
...
- [V2 Roadmap](../docs/V2_ROADMAP.md) — Current state + roadmap (updated 0.10.9)
...
- [Changelog](CHANGELOG.md) — Version history (0.1.0 → 0.10.9)
- [License](../LICENSE) — MIT

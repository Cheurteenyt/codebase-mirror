# Codebase Memory V2 changelog archive — 0.12.0 through 0.75.0

> **Status:** Historical release record
> **Audience:** Maintainers and auditors
> **Archived:** 2026-07-20; current releases continue in [v2/CHANGELOG.md](../../../v2/CHANGELOG.md)
...
- **`docs/architecture/ATOMIC_GENERATION_PUBLICATION.md`** (NEW): comprehensive
...
- **`docs/architecture/V2_ARCHITECTURE.md`** (NEW): v2 architecture overview.
  Covers the module dependency graph, the storage layer, the indexer
  pipeline, the UI server, and the MCP tools.
- **`docs/reference/V2_CURRENT_STATE.md`** (NEW): current state of the v2
...
- `docs/reference/V2_CURRENT_STATE.md` (STEP9 header).
...
- `v2/CHANGELOG.md` (this entry).
- `docs/reference/V2_CURRENT_STATE.md` (STEP8 header).
...
- `v2/CHANGELOG.md` (this entry).
- `docs/reference/V2_CURRENT_STATE.md` (STEP7 header).
...
- `v2/CHANGELOG.md` (this entry).
- `docs/reference/V2_CURRENT_STATE.md` (STEP6 header).
...
- `v2/tests/storage/r169b-generation-cas.test.ts` (update reconcile test
  for RECOVER action).
- `v2/CHANGELOG.md` (this entry).
- `docs/architecture/ATOMIC_GENERATION_PUBLICATION.md` (STEP5 pipeline, honest
  limitations).
- `docs/reference/V2_CURRENT_STATE.md` (STEP5 header).
...
- `v2/CHANGELOG.md` (this entry).
- `docs/architecture/ATOMIC_GENERATION_PUBLICATION.md` (STEP4 pipeline, copy/reflink,
  Model A GC).
- `docs/reference/V2_CURRENT_STATE.md` (STEP4 header).
...
Updated in `docs/architecture/ATOMIC_GENERATION_PUBLICATION.md` and
`docs/architecture/V2_ARCHITECTURE.md`.
...
`docs/architecture/ATOMIC_GENERATION_PUBLICATION.md` and `docs/architecture/V2_ARCHITECTURE.md`:
...
- `docs/architecture/ATOMIC_GENERATION_PUBLICATION.md` — §4.4 Index-state schema
...
- **`docs/architecture/ATOMIC_GENERATION_PUBLICATION.md`** (new) — full target
...
- **`docs/reference/V2_CURRENT_STATE.md`** — header updated to R169A; R169A
...
- **`docs/architecture/V2_ARCHITECTURE.md`** — header status marked FOUNDATION /
...
- `docs/architecture/ATOMIC_GENERATION_PUBLICATION.md` (new; updated by R169A-FIX
  pass 1 and pass 2 — adds §6.3 trust root, §6.4 layout durability,
  §6.5 project-aware writer)
- `docs/reference/V2_CURRENT_STATE.md` (updated)
- `docs/architecture/V2_ARCHITECTURE.md` (updated; adds §15.5.2 trust root,
...
- **DOC-R168.1-01**: added the missing R168 CHANGELOG entry (0.73.0).
  ...
  present.
- **DOC-R168.1-02**: `docs/reference/V2_CURRENT_STATE.md` header updated from
...
- `docs/reference/V2_CURRENT_STATE.md`: header updated to R168.1.
...
- **docs/operations/GITHUB_GITLAB_BRANCH_BRIDGE.md**: extended with 8 new sections
...
- **docs/operations/CI_CONTINUITY.md** (NEW): operational resilience plan with
...
- **docs/reference/V2_CURRENT_STATE.md**: added R167 section + operational
  verdict.
- **v2/CHANGELOG.md**: this entry.
...
- `docs/operations/GITHUB_GITLAB_BRANCH_BRIDGE.md`: added sections 11–18
  (postmortem, env contract, SSH identities, protected branch auth,
  diagnostic matrix, dry-run limitations, GitHub API limitations,
  break-glass runbook).
- `docs/operations/CI_CONTINUITY.md` (NEW): operational resilience plan.
- `docs/reference/V2_CURRENT_STATE.md`: added R167 section.
...
- `docs/operations/GITHUB_GITLAB_BRANCH_BRIDGE.md`: rewritten as
  "GitHub Canonical → GitLab Passive Mirror" reference.
- `docs/reference/V2_CURRENT_STATE.md`: updated CI/CD section.
...
- `docs/reference/V2_CURRENT_STATE.md` (R164 section + carryover limitations)
...
- `docs/reference/V2_CURRENT_STATE.md`: updated header + validation date to R162;
...
210. **P2 graph-ui branches don't flow to GitLab MRs**
     ...
     `docs/operations/GITHUB_GITLAB_BRANCH_BRIDGE.md`) — Frontend contributors had
     ...
     `docs/operations/GITHUB_GITLAB_BRANCH_BRIDGE.md`. (CI-FLOW-R156-01)
...
- **docs/reference/V2_CURRENT_STATE.md**: updated to R145, semantics 8.
...
122. **DOC-R143-02**: docs/reference/CLI_REFERENCE.md — added `cbm-v2 index` command
...
123. **DOC-R143-03**: docs/reference/V2_CURRENT_STATE.md created — authoritative
...
126. **DOC-R143-06**: docs/history/roadmaps/V2_ROADMAP.md — labeled as historical archive
...
2. **`docs/history/roadmaps/V2_ROADMAP.md`** — Added archive banner: "Historical roadmap, archived at 0.15.9. For current version, see v2/CHANGELOG.md."
...
- Modified: `docs/history/roadmaps/V2_ROADMAP.md` (archive banner)
...
- New: `docs/history/benchmarks/RIGOROUS_BENCHMARK_R78.md` (full report with methodology, results, 8 bugs)
...
- New: `docs/history/benchmarks/RIGOROUS_BENCHMARK_R77.md` (full report with fairness notes)
...
- **Fix**: added a "Caveat on node counts" section to `docs/history/benchmarks/V1_V2_BENCHMARK_R67.md`
...
numbers. Full report: docs/history/benchmarks/V1_V2_BENCHMARK_R67.md.
...
Full report: docs/history/benchmarks/PERFORMANCE_BENCHMARK_R66.md
...
### Audit report (docs/history/audits/V1_AUDIT_R65.md)

Full audit report created at `docs/history/audits/V1_AUDIT_R65.md` documenting:

...
> **Status:** Canonical data-model reference
...
> Voir [V2 architecture](../architecture/V2_ARCHITECTURE.md#6-human-memory-graph)
> pour la stratégie « deux DBs, jointures à la lecture ».

...
| [R184 Ariad versus Graphify truth audit](performance/reports/R184_ARIAD_VS_GRAPHIFY_TRUTH_AUDIT_2026-07-24.md) | Sealed four-arm index, query, update, human-memory, and Graph UI result with wins and losses |

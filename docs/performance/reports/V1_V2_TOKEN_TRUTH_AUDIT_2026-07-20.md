...
> **Status:** Evidence report — benchmark complete after two pre-registered optimization cycles
...
semantic change from sections 4 and 12 of `docs/performance/BENCHMARK_PROTOCOL.md`. The
...
Grading preserves section 5 of the
[benchmark protocol](../BENCHMARK_PROTOCOL.md): normalize CRLF and path

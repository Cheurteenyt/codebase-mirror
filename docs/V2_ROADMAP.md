...
| R78–R115 | 0.16.0–0.50.0 | — | — | — |
| **Total** | | **566+** | **513+** | **378** |

> **Note:** Rounds R78–R115 (versions 0.16.0–0.50.0) are documented in
...
> The V2 indexer now has 114 tests across 20 test files covering correctness,
...
> type-only import filtering, precision benchmark validation, benchmark metrics
> honesty, row-level attribution, and namespace import resolution.
